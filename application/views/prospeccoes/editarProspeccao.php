    ...
    <div class="span12">
        <div class="widget-box">
            <div class="widget-title" style="margin: -20px 0 0">
                ...
                <h5>Editar Prospeccao</h5>
            </div>
            <div class="widget-content nopadding tab-content">
                <?php echo $custom_error; ?>
                <form action="<?php echo current_url(); ?>" id="formProspeccao" method="post" class="form-horizontal">
                    <?php echo form_hidden('idProspeccoes', $result->idProspeccoes) ?>
                    ...
                    <div class="form-actions">
                        <div class="span12">
                            <div class="span6 offset3" style="display:flex;justify-content: center">
                                ...
                                <a href="<?php echo base_url() ?>index.php/prospeccoes" id="btnAdicionar" class="button btn btn-mini btn-warning" style="max-width: 160px">
