                                ...
                                <div id="tab1" class="tab-pane active" style="min-height: 300px">
                                    <div class="accordion" id="collapse-group">
                                        ...
                                        <div class="accordion-group widget-box">
                                            <div class="accordion-heading">
                                                <div class="widget-title">
                                                    <a data-parent="#collapse-group" href="#collapseGTwelve"
                                                        data-toggle="collapse">
                                                        <span><i class='bx bx-car icon-cli'></i></span>
                                                        <h5 style="padding-left: 28px">Fornecedores</h5>
                                                        <span><i class='bx bx-chevron-right icon-clic'></i></span>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="collapse in accordion-body" id="collapseGTwelve">
                                                <div class="widget-content">
                                                    <table class="table table-bordered">
                                                        <tr>
                                                            <td colspan="4"></td>
