                        ...
                        <div class="control-group">
                            ...
                            <div class="span8">
                                ...
                                <div class="span10" style="margin-left: 3em;">
                                    ...
                                    <label> <input <?= @in_array("Negociação", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Em Negociação"> <span class="lbl"> Negociação</span> </label>
