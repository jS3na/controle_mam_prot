...
<div class="new122">
    ...
    <div class="span12" style="margin-left: 0">
        ...
        <?php } ?>
        <form class="span9" method="get" action="<?= base_url() ?>index.php/fornecedores"
            style="display: flex; justify-content: flex-end;">
            <div class="span3">
                <input type="text" name="pesquisa" id="pesquisa"
                    placeholder="Buscar por Nome, Cnpj ou Cidade..." class="span12"
    ...
    <div class="widget-box">
        ...
        <div class="widget-content nopadding tab-content">
            <table id="tabela" class="table table-bordered ">
                ...
                <!-- cobranças
                 referidas ao clientes registrados na os
                  -->
                <tbody>
                    <?php
                    if (!$results) {
                    ...
                    foreach ($results as $r) {
                        ...
                        echo '<td>' . $r->cnpj . '</td>';
                        echo '<td>' . $r->telefone_comercial . '</td>';
...
<div id="modal-excluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <form action="<?php echo base_url() ?>index.php/fornecedores/excluir" method="post">
        ...
        <div class="modal-body">
            ...
            <h5 style="text-align: center">Deseja realmente excluir este fornecedor e os dados associados a ele (OS,
                Vendas, Receitas)?</h5>
        </div>
