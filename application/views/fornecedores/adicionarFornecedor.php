    ...
    <div class="span12">
                ...
                <div class="widget-content nopadding tab-content">
                    <div class="span6">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="cnpj" class="cpfcnpj" type="text" name="cnpj" value="<?php echo set_value('cnpj'); ?>" />
                                <!--
        ...
        -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="telefone_comercial" type="text" name="telefone_comercial" value="<?php echo set_value('telefone_comercial'); ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="telefone_financeiro" class="control-label">Telefone Financeiro</label>
                            <div class="controls">
                                <input id="telefone_financeiro" type="text" name="telefone_financeiro" value="<?php echo set_value('telefone_financeiro'); ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="telefone_suporte" class="control-label">Telefone Suporte</label>
                            <div class="controls">
                                <input id="telefone_suporte" type="text" name="telefone_suporte" value="<?php echo set_value('telefone_suporte'); ?>" />
                            </div>
                        </div>
                        <div class="control-group">
